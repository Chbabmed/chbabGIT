...
<body>
    ...
    <section id="content">
        ...
        <nav>
            ...
            <span id="title">Les missions</span>
        ...
        <div class="mission">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="col text-end " style="margin-right: 3rem;">
                            <button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#AjouterMission" id="ajout">Ajouter</button>
                                ...
                                <tbody class="table-group-divider ">
                                    <tr  >
                                        ...
                                        <td class="text-center">
                                            <a href="#Editrep" data-bs-toggle="modal" data-bs-target="#EditMiss">
            ...
            <div class="modal fade" id="AjouterMission" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal fade" id="EditMiss" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog  modal-lg mt-5" >
                    <div class="modal-content">
                        <div class="modal-header">
